...
--
-- GameTooltip lines of the player (determined via: _UnitIsUnit(unitID, "player")):
--
...
--
-- GameTooltip lines of other player (determined via: UnitIsPlayer(unitID) and not _UnitIsUnit(unitID, "player")):
--
-- content                                           color                                                                    example
-- ------------------------------------------------  -----------------------------------------------------------------------  ------------------------------------------
...
local function AddTarget(lineList,target,targetName)
	if (_UnitIsUnit("player",target)) then
...
-- TARGET
function ttStyle:_GenerateTargetLines(unitRecord, method)
...
function ttStyle:GenerateTargetLines(unitRecord, method)
    pcall(ttStyle._GenerateTargetLines, ttStyle, unitRecord, method)
end
