...
tinsert(ttOptionsGeneral, { type = "DropDown", var = "showMapAndZoneAndSubzone", label = "Show Player Location", tip = "Location data is only available for your player and party members. Zone and Subzone is only available for your player.", list = { ["|cffffa0a0Do not show"] = "none", ["Show map/zone/subzone"] = "mapAndZoneAndSubzone", ["Show map/zone"] = "mapAndZone", ["Show map only"] = "map", ["Show zone/subzone"] = "zoneAndSubzone", ["Show zone only"] = "zone" }, enabled = function(factory) return factory:GetConfigValue("showUnitTip") end, y = 10 });
